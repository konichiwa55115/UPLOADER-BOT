class Translation(object):
    ...
    START_TEXT = """السلام عليكم يا  {},
أنا بوت رفع الملفات 
فقط أرسل لي أي رابط تحميل مباشر و أنا أقوم برفع الملف إلى تلجرام 
لا تستعمل البوت في رفع شيء حرام . قد لا يراك المصمم لكن الله يراك 
لباقي البوتات هنا 
